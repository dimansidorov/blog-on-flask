from combojsonapi.permission.permission_system import \
    PermissionMixin, PermissionUser, PermissionForGet, PermissionForPatch
...
class UserPermission(PermissionMixin):
    ...
    def patch_data(self, *args, data: dict = None,
                   obj: User = None, user_permission: PermissionUser = None, **kwargs) -> dict:
